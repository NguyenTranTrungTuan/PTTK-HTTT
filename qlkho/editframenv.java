...
public class editframenv extends JFrame implements ActionListener {
    ...
    public editframenv(NhanVien nv) {
        setSize(800, 600);
        ...
        tf_password.setText(nv.getPassword());
        gbc.gridx = 1;
        gbc.gridy = 5;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        ...
        for (NhanVien nv1 : listnv) {
            if (nv1.getChucVu().equals("Quản lý")) {
                cb_nql.addItem(nv1.getTenNV());
            }
        }
        ...
        if (nv.getManql() != null) {
            for (NhanVien nv1 : listnv) {
                if (nv1.getMaNV().equals(nv.getManql())) {
                    cb_nql.setSelectedItem(nv1.getTenNV());
                }
            }
        } else {
